...
export const Profile = () => {
  ...
  const API_URL       = process.env.REACT_APP_API_BASE_URL || 'http://projecte-final-equip08-2.onrender.com';
  ...
  // Mostramos el loadingSvg mientras el perfil está cargando
  if (loading) {
    return (
  ...
  // Si ya terminó de cargar pero no hay perfil, mostramos un mensaje de error
  if (!profile) {
        ...
        <div className="flex flex-col sm:flex-row p-6 space-y-6 sm:space-y-0 sm:space-x-6">
          ...
          <div className="flex-1 flex flex-col space-y-6">
            <div className="flex flex-col sm:flex-row items-center sm:items-start space-y-6 sm:space-y-0 sm:space-x-6">
              ...
              {/* Info de usuario o formulario, centrado en móvil */}
              {!isEditing ? (
