...
export const Register = () => {
  ...
  // Limpiar URL anterior cuando cambie la foto
  useEffect(() => {
    return () => {
  ...
  return (
    <div className="mt-30 bg-white flex flex-col justify-center items-center px-4">
      <div className="border border-gray-300 bg-white p-6 rounded-lg w-full max-w-3xl">
        ...
        {/** 
         * Cambiamos aquí: 
         *   - De `flex space-x-8` a `flex flex-col md:flex-row`, de modo que en móvil
         *     quede una columna (flex-col) y a partir de md (>=768px) pase a dos columnas (flex-row).
         *   - Añadimos `space-y-6 md:space-y-0 md:space-x-8` para que en móvil separe  
         *     verticalmente con “space-y-6” y en desktop separe solo en horizontal con “space-x-8”.
         */}
        <form
        ...
        >
          {/** 
           * Columna izquierda (en desktop). En móvil, al ser flex-col, irá encima del formulario. 
           * Le damos un ancho fijo a partir de md (por ejemplo, 1/3) para que no ocupe demasiado.
           */}
          ...
          {/** 
           * Columna derecha (en desktop). En móvil, irá debajo de la imagen.
           * Se extiende al resto del espacio con flex-1 cuando estamos en desktop. 
           */}
          <div className="w-full md:flex-1 space-y-4">
            ...
            {/** 
             * En desktop estas dos contraseñas van a estar lado a lado (flex-row), pero en móvil, 
             * al ser contenedor `space-y-4` dentro de un flex-col, quedan apiladas verticalmente.
             */}
