...
export const Login = () => {
  ...
  return (
    <div className="mt-30 bg-white flex flex-col justify-center items-center px-4">
      {/** 
       * - Se añade `px-4` para asegurar un padding horizontal en móvil 
       * - El contenedor interior pasa de `p-8 max-w-lg` a `p-6 max-w-md md:max-w-lg` 
       *   para que en móvil (ancho < 768px) quede más estrecho y cómodo,
       *   y en desktop recupere `max-w-lg`. 
       */}
      <div className="border border-gray-300 bg-white p-6 rounded-lg w-full max-w-md md:max-w-lg">
        ...
        {/**
         * El contenedor de inputs ya estaba con `space-y-4`. 
         * Se deja igual porque en móvil queremos que queden apilados y 
