// src/pages/tournaments/CreateTournament.jsx
    ...
    <div className="w-full max-w-md sm:max-w-2xl mx-auto mt-30 px-4 sm:px-6 lg:px-8">
      <div className="bg-white rounded-lg border border-gray-300 p-6">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          {/*
            En móvil (flex-col) ambos inputs se apilan; a partir de sm (≥640px) van lado a lado.
          */}
          ...
          <div>
            ...
            {/*
              En móvil el mapa mide h-64 (16rem ≃ 256px);
              a partir de sm (≥640px) pasa a h-[350px].
            */}
            <MapContainer
