// src/pages/games/GameDetail.jsx
...
export default function GameDetails() {
  ...
  // 2) Cargar estadísticas del partido
  useEffect(() => {
    if (!token) return;
  ...
  // 4) Decodificar usuario del token
  useEffect(() => {
    if (!token) return;
    try {
  ...
  // 5) Determinar si el partido ya pasó
