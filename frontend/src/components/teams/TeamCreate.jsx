  ...
  return (
    <div className="mt-30 bg-white flex flex-col justify-center items-center px-4">
      <div className="w-full max-w-md md:max-w-3xl bg-white border border-gray-300 rounded-lg p-6 md:p-8">
        ...
        {/**
         * Cambiamos de `flex space-x-8` a `flex flex-col md:flex-row`,
         * y de `space-x-8` a `space-y-6 md:space-y-0 md:space-x-8`:
         * - En móvil: apila verticalmente con `space-y-6`.
         * - En md (≥768px): se convierte en fila con `space-x-8`.
         */}
        <form
        ...
        >
          {/* Columna izquierda: preview de la foto */}
          ...
          {/* Columna derecha: inputs del formulario */}
