...
const TeamDetails = () => {
  ...
  // ID del usuario actual (para startChat)
  ...
  // ───── Agregamos este useEffect para cerrar el dropdown al hacer click fuera ─────
  useEffect(() => {
  ...
  // 3) Compruebo si yo tengo solicitud pendiente
  useEffect(() => {
    if (!token) return;
  ...
  // 4) Solo el capitán carga la lista de solicitudes
  useEffect(() => {
  ...
  // Función para iniciar chat (igual que en UsersList)
